...
% Lege hier Meta-Informationen für den Vortrag fest
...
\author{Max Muster} 
\institute[Vortrag]{Vortrag Arbeit beim Birnbaum-Institut}
\date{1.1.2019}

\begin{document}

\frame{\titlepage} % erstelle die Titel-Seite mit den Meta-Informationen
